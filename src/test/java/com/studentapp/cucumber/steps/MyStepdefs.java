...
import com.studentapp.studentsinfo.StudentSteps;
...
public class MyStepdefs {
    ...
    public void updatesTheCreatedRecordWithNewEmailUsingPUTRequestAndDetails(String firstName, String lastName, String programme, String course1, String course2)  {
        ...
        courseList.add(course2);
        email = "updated"+email;
        response = studentSteps.updateStudent(studentId,firstName,lastName,email,programme,courseList).statusCode(200);
