Feature: Testing different request on the student application
  ...
  Scenario Outline: Check if user can create, read, update and delete a record
    ...
    Examples:
      ...
      | krishna   | Patel    | prime1@gmail.com   | Computer Science | JAVA    | Ruby    |
      | Sam       | Patel    | prime123@gmail.com  | Computer Science | JAVA    | Ruby    |
      | Parin     | Patel    | prime1234@gmail.com | Computer Eng     | php     | C#      |
